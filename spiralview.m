...
- (void)drawRect:(CGRect)rect // to be un-comment for drawing | will override
{
    // Drawing code
...
-(void)touchesBegan:(NSSet<UITouch *> *)touches withEvent:(UIEvent *)event // called when touch the screen
{
    if (initialWidth == 0)
